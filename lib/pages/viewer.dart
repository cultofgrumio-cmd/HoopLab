...
class _ViewerPageState extends State<ViewerPage> {
  ...
  Future<void> initializeYOLO() async {
    ...
    print('VideoSnapshotGenerator available: $isAvailable');
    ...
    Stream<Map<String, dynamic>> inference() async* {
      ...
      for (var t in results) {
        Uint8List thumbBytes = File(t.path).readAsBytesSync();
        final prediction = await yolo.predict(thumbBytes);
        yield prediction;
      }
    }
                              ...
                              ? Column(
                                  children: [
                                    Slider(
                                      ...
                                      min: 0,
                                      max: clip.videoInfo!.totalFrames
                                          .toDouble(),
